...
public class MainActivityTest {
    ...
    @Rule
    public ActivityTestRule<AddBabyActivity> mainActivityActivityTestRule = new ActivityTestRule<>(
            AddBabyActivity.class, true, false);

    AddBabyActivity mainActivity;
    ...
    public void testDefaultDatePickerDialogDisplays() {
        //act
        onView(withId(R.id.edt_add_birthday)).perform(click());

        //assert
        onView(withId(com.t3h.immunization.R.id.datePickerContainer))
                .check(matches(isCompletelyDisplayed()));
        onView(withId(com.t3h.immunization.R.id.parent))
                .check(matches(isCompletelyDisplayed()));
        onView(withId(com.t3h.immunization.R.id.year))
                .check(NumberPickers.isDisplayed("1980"));
        onView(withId(com.t3h.immunization.R.id.month))
                .check(NumberPickers.isDisplayed("Jan"));
        onView(withId(com.t3h.immunization.R.id.day))
